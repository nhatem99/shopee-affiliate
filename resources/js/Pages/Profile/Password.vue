    ...
    <AccountLayout>
        <div class="space-y-6">
            ...
            <div class="card p-6">
                ...
                <!-- Ô nhập: bỏ, dùng .focus-ring. Đây là form gõ bằng bàn phím
                     từ đầu tới cuối, mất vòng focus là mất luôn chỗ đang đứng. -->
                <form @submit.prevent="savePassword" class="space-y-4">
                    <div v-if="hasPassword">
                        ...
                        <p v-if="passwordForm.errors.current_password" class="text-xs text-[var(--color-danger)] mt-1">{{ passwordForm.errors.current_password }}</p>
                    </div>
                    <div>
                        ...
                        <p v-if="passwordForm.errors.password" class="text-xs text-[var(--color-danger)] mt-1">{{ passwordForm.errors.password }}</p>
                    </div>
                    <div>
